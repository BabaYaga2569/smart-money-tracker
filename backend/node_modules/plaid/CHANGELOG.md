...
- Update supported payment scheme options for `/payment_initiation/payment/create`
  â€“ Update description of `/payment_initiation/recipient/create` to mention non-Eurozone countries.
  â€“ Update `/payment_initiation/payment/create` mentioning new currencies and non-Eurozone markets.
  â€“ Removed `CHF` and `CZK` from the list of supported currencies.
